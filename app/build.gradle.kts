...
val latestTag = repo?.latestTag?.removePrefix("v") ?: "7.4.1-SNAPSHOT"
...
android {
    ...
    composeOptions.kotlinCompilerExtensionVersion = libs.versions.compose.ompiler.get()
...
dependencies {
    ...
    implementation(libs.ktorfit.flower)
