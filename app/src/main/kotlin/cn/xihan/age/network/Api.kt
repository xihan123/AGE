...
object Api {
    ...
    val BASE_URL =// "https://v2.age-api.com:8443/v2/"
        Settings.mainConfigModel.aGEEntity.coreApi.ifBlank { "https://v2.age-api.com:8443/v2/" }
    ...
    val PLAYER_PARSER =
        Settings.mainConfigModel.aGEEntity.tmm3pPlay.ifBlank { "https://zj.sp-flv.com:8443/?url=" }
    ...
    const val CONFIG_URL = "https://age-api.mengzx.cn:8443/Main-740.json"
