...
import cn.xihan.age.component.LoadingState.Finished
import cn.xihan.age.component.LoadingState.Loading
...
class WebViewNavigator(private val coroutineScope: CoroutineScope) {
    private sealed interface NavigationEvent {
        ...
        data class LoadUrl(
            val url: String, val additionalHttpHeaders: Map<String, String> = emptyMap()
        ) : NavigationEvent
...
fun rememberWebViewState(
    url: String, additionalHttpHeaders: Map<String, String> = emptyMap()
): WebViewState =
