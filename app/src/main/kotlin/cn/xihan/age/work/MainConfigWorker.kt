...
class MainConfigWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        remoteRepository.getConfigModel(Api.CONFIG_URL)
            .catch {
                setSplash(Settings.mainConfigModel.appEntity.splashLink)
                PopTip.show(
                    String.format(
            ...
            .collect {
                ...
                Utils.saveLabel(it.aGEEntity)
                setSplash(it.appEntity.splashLink)
            }
        return Result.success()
    }

    private fun setSplash(it: MainConfigModel.AppEntityModel.SplashLinkModel) {
