 ...
 */
@Database(
    entities = [(AnimeDetailModel.AniInfoModel::class),(CatalogModel.AniPreLModel::class), (FavoriteModel::class), (HistoryModel::class)],
    version = 7,
    exportSchema = true,
)
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun animePreLModelDao(): AniPreLModelDao
