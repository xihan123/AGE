...
//        }
            ...
            engine {
                ...
                if (SharedPreferencesUtil("SPSetting").decodeBoolean("customProxy")) {
                    proxy = ProxyBuilder.socks(
                        host = SharedPreferencesUtil("SPSetting").decodeString("proxyHost"),
                        port = SharedPreferencesUtil("SPSetting").decodeInt("proxyPort")
                    )
                }
            }
        }
